    ...
    return (
      <div className="relative mb-10 mt-10 flex min-h-screen flex-col justify-center overflow-hidden">
        <div className="m-auto w-full rounded-md  bg-white px-0 pb-4 pt-0 lg:max-w-full">
          <nav className="navcustomproperty relative mb-2 flex flex-wrap items-center justify-between rounded-md py-1 pl-2 pr-0 ring-1 ring-blue-700 h-10">
                                      ...
                                      return (
                                        <>
                                          {receiptDetails[0]
                                            ...
                                            //     receiptDetails[0]?.payment_details[index]?.property_tax_arrear != 0 ? (
                                            <tr>
