...
function DemandReceipt({ showModal, currModal, propId, switchOnPrevModalNOffCurrModal,
                                ...
                                <tr>
                                  ...
                                  >
                                    ...
                                    <div className="float-left ml-2 text-left  text-xs font-semibold text-gray-900">
                                      {receiptDetails[0]?.total} (In words.){" "}
                                    </div>
                        ...
                        <li className="mb-0 mt-0">
                          <span className="text-xs font-normal text-gray-900 dark:text-white">
                            <p className="contents whitespace-normal text-xs font-bold text-red-600">
                              This is not a Property Tax Receipt
                            </p>
                          </span>
                        </li>
                        <li className="mb-0 mt-0">
        ...
        {isReceipLoaded == false ? (
          <>
            <p className="text-center text-sm font-semibold text-red-700">
              Unable to load demand receipt details
            </p>
            <button
              onClick={() =>
                switchOnPrevModalNOffCurrModal(currModal, prevModal)
