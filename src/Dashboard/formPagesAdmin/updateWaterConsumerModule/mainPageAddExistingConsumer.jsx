...
//         entry_date: "2017-07-22",
//         entry_time: "10:03:23.0000000",
//         user_id: 1,
//         status: 1
//     },
//     {
...
//         amount: 350.00,
//         date_of_effect: "1965-04-01",
//         entry_date: "2017-07-24",
//         entry_time: "06:19:10.0000000",
//         user_id: 1,
//         status: 1
//     },
//     {
...
//         amount: 1000.00,
//         date_of_effect: "1965-04-01",
//         entry_date: "2018-04-24",
//         entry_time: "15:42:44.0000000",
//         user_id: 140,
//         status: 1
//     }
// ]
   ...
   // paymentDetail.dueUpTo = demandDetailWater.demandUpTo
    ...
    //navigate('/dashboard/updateWaterConsumer/updateWaterConsumerPaymentReceipt')
        try {
            ...
            const safNewEntryUrl = `${SUDA_API_BASE_URL}/user/Water/AddWaterEntry`
       ...
       <form className="mt-4" onSubmit={handleSAFNewFormSubmission}>
         ...
         lg:max-w-full">
           ...
           items-end lg:justify-between">
                       ...
                       {/* <div className="mb-4 ml-3 mt-2 min-w-fit max-w-fit flex">
                             <label className=" w-[11rem]  block text-gray-700 text-xs font-bold mb-2 "   htmlFor="password">
                                 New Consumer No<p className='contents text-red-600
                                  text-sm font-bold'>*</p>
                             </label>
                             <Tooltip className={`text-xs bg-red-300 text-black-900 inline w-64 
                             ${addExistingCustomerValidator.isOldConsumerValid == false ? `` : `hidden`}`}
                                 ...
                                 animate={{
                                  ...
                                  <input
                                   onChange={(e)=>handleAddExistingCustomerHandler(e,'')}
                                   name="newConsumerNo"
                                   value={consumerDetail.newConsumerNo}
                                     className="bg-white-200 appearance-none border 
                                        border-gray-500 rounded w-full py-2 px-4 text-white-700 leading-tight 
                                         focus:outline-none focus:bg-white focus:border-2 focus:border-blue-500"
                                     id="newconsumer_no" type="text" placeholder="" />
                              </Tooltip>
                         </div> */}
                   </div>
           ...
           items-end lg:justify-between">
             ...
             <LocalizationProvider dateAdapter={AdapterDayjs}>
                 ...
                 <Select 
                      name="connectionType"
                      id="connectionType"
                      defaultValue={demandDetailWater.unitRate}
                      onChange={(e)=>handleDemandDetailsWater(e,'')}
                                 ...
                                 `border-red-900` : ``}`}>
                         {
                             rate.length > 0 ?
                                 (rate.map((item) => {
                                     const { 
                                         id, prop_type_id,conn_type_id,range_mstr_id,amount,date_of_effect, entry_date, entry_time,user_id,status
                                      } = item
                   ...
                   <input 
                                      ...
                                      //onChange={(e)=>handleDemand}
                                         className={`bg-white-200 appearance-none border border-gray-500 rounded w-72 py-2 px-4 text-white-700 leading-tight focus:outline-none focus:bg-white focus:border-2 focus:border-blue-500
                 ...
                 <DesktopDatePicker
                     // label="Date desktop"
                     onChange={(e)=>handleDemandDetailsWater(e, "demandUpTo")}
                                  name="demandUpTo"
                                // value={consumerConnectionDetails.dateOfConnection}
                     id="demandUpTo"
                     inputFormat="YYYY-MM-DD"
                     ...
                     />}
                     //disableFuture={true}
                     value={demandDetailWater?.demandUpTo}
                   />
                 </Stack>
               </LocalizationProvider>
                       </div> */}
