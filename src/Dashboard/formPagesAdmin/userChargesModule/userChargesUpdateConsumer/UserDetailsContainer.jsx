  ...
  return (
    <>
      ...
      <>
        ...
        <nav className="relative flex flex-wrap items-center justify-between pl-2 pr-0 py-1 navcustomproperty mb-1 ring-1 ring-red-700 bg-orange-800 mt-3 rounded-lg h-10">
          <h2 className="text-sm font-semibold text-center text-white">
            Area Details
          </h2>
        </nav>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-1 md:gap-3 px-2 py-3 md:px-6">
                    ...
                    <div className='py-2 text-xs font-normal  text-gray-700 whitespace-normal flex gap-3 '>
                      ...
                      <Select
                        ...
                        id={`selectedRelation`}
                        color='gray'
                        className="w-full pl-2 pr-3 py-1 font-bold text-xs text-gray-900">
